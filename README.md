...
Seraph — автономная UI-библиотека для Roblox/Luau. Она рассчитана на загрузку одним файлом через `loadstring`, не требует внешних зависимостей и оформляет интерфейс в стиле Material Design 3 с визуальной метафорой окна браузера.
